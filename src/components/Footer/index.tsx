import logo from '../../assets/images/logos/Mintocode Logo Escura.svg'
      ...
      <div className="max-w-7xl mx-auto px-6">
        <div className="grid md:grid-cols-4 gap-12">
          <div className="md:col-span-2">
            ...
            <p className="text-slate-900 max-w-md">
              ...
              Design moderno, código limpo e performance otimizada.
            </p>
          </div>
          ...
          <div>
            <h4 className="font-semibold text-lg mb-4 text-text">Contato</h4>
            <div className="flex flex-col gap-3">
              <a 
                href={whatsappLink}
                target="_blank"
                rel="noopener noreferrer"
                className="text-slate-900 hover:text-primary transition-colors flex items-center gap-2"
              >
        ...
        <div className="border-t border-slate-900 mt-12 pt-8 text-center">
          <p className="text-slate-900 text-sm">
            © {new Date().getFullYear()} Mintcode. Todos os direitos reservados.
          </p>
        </div>
      </div>
    </footer>
