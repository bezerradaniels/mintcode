        ...
        <div className="grid md:grid-cols-4 gap-12">
          ...
          <div>
            ...
            <nav className="flex flex-col gap-3">
              ...
              <a href="#portfolio" className="text-gray-400 hover:text-primary transition-colors">Portfolio</a>
              <a href="#sobre" className="text-gray-400 hover:text-primary transition-colors">Sobre</a>
            </nav>
          </div>
